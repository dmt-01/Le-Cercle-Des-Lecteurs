                ...
                <ul className="mt-2.5 flex flex-col gap-1.5">
                  {[
                    ...
                    <li key={label} className="flex items-center gap-2">
                      <span
                        className={`w-4 h-4 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0 ${ok ? "bg-green-100 text-green-600" : "bg-primary/10 text-primary/30"}`}
                      >
                        {ok ? "✓" : "·"}
                      </span>
                      <span
                        className={`text-xs transition-colors ${ok ? "text-green-600" : "text-primary/40"}`}
                      >
                        {label}
                      </span>
                    </li>
            ...
            <div className="flex flex-col gap-3">
              ...
              <label className="flex items-start gap-2.5 cursor-pointer">
                <input
                  ...
                  onChange={(event) =>
                    setAcceptNewsletter(event.target.checked)
                  }
                  className="w-4 h-4 mt-0.5 accent-secondary rounded shrink-0"
                />
                <span className="text-xs text-primary/60 leading-relaxed">
                  J'accepte de recevoir les lettres d'information du Cercle.
                  (optionnel)
                </span>
              </label>
            </div>
